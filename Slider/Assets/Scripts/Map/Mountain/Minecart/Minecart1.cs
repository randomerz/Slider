...
public class Minecart1 : Item, ISavable
{
    [Header("Movement")]
    ...
    {   
        ...
        bool canDrop = CheckFreeInFront() && tile != null;
        if(canDrop) Drop(tile);
        return canDrop;
    }
    ...
    private bool CheckFreeInFront()
    {
        ...
        return !Physics2D.OverlapBox(checkLoc, Vector2.one, 0, collidingMask);
    }
