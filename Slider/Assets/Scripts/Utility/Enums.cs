...
public static class Areas
{
    ...
    public static string GetDiscordName(this Area area) 
        => SaveSystem.Current.GetLocalizedStringPair(SpecificTypeHelpers.AreaToDiscordNamePath(area)).TranslatedFallbackToOriginal;
    ...
    public static string GetDisplayName(this Area area)
        => SaveSystem.Current.GetLocalizedStringPair(SpecificTypeHelpers.AreaToDisplayNamePath(area)).TranslatedFallbackToOriginal;
}
